...
# question4 = Question.create!(asker_id: 1, views: 0, title: "Question about Node.js", body: "What is rails?")
# question5 = Question.create!(asker_id: 2, views: 0, title: "Question about MERN", body: "What is rails?")
# question6 = Question.create!(asker_id: 3, views: 0, title: "Question about fullstack", body: "How to make your fullstack project look perfect?")

# Vote1 = Vote.create!(votable_type: 'Question', voter_id: 37, score: 1, votable_id: 1)